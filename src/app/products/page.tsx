...
const products = [
  {
    ...
    description:
      "A fast website that works well on every device, built to turn visitors into leads. We design with your trade and your customers in mind: clean layout, clear calls to action, and pages built to rank in local search.",
    features: [
      "10 to 20 page custom site",
  ...
  },
  {
    ...
    features: ["On page SEO", "Google Business Profile setup"],
    path: (
      <>
